...
#define STRING_CONFIG_H_AUTHOR "(BaldurThor, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Custom-3"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 88.71
  #define DEFAULT_bedKi 16.55
  #define DEFAULT_bedKd 316.98
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 101.96 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -38, 6, -1 }
...
#define HOMING_FEEDRATE_MM_M { (8000), (8000), (5*60) }
